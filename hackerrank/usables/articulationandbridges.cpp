...
#define UNVISITED 0
vi dfs_num,dfs_low,dfs_par,artp;
vector<vi> edges;
int n,m,x,y;
int dfs_counter,dfsroot,rootchildren;
...
int main()
{
	...
	loop(i,n)
	{
		if(dfs_num[i]==UNVISITED)
		{
			...
			artp[dfsroot]=(rootchildren>1);
		}
	}
	cout<<"Articulation Points : ";
	loop(i,n)	if(artp[i])	cout<<i<<" ";
	return 0;
}
